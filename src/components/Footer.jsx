                ...
                <div className="footer-grid">
                    ...
                    <div className="footer-map">
                        ...
                        <div className="map-container">
                            <iframe
                                src="https://www.google.com/maps/embed/v1/place?key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8&q=Thai+Herb+Center+Community+Enterprise,Nonthaburi,Thailand&zoom=17"
                                width="100%"
                                height="180"
                                ...
                                title="Thai Herb Center Location"
                            />
                        </div>
                    </div>
                </div>
